...
import AddFaculty from "./Page/AddFaculty";
import FacultyList from "./Page/FacultyList";
  ...
  return (
    <>
      <BrowserRouter>
        ...
        <Route path='/AddFaculty' element={ <Protected> <AddFaculty /></Protected> }></Route>
        <Route path='FacultyList' element={ <Protected> <FacultyList /></Protected> }></Route>  
        ...
        <Route path="/Performance" element={<Protected><Performance /></Protected>}></Route>
